...
if __name__ == "__main__":
    ...
    parser.add_argument('--marker-size', type=float, dest='marker_size',
                        default='30.0', help='marker size in mm')

    args = parser.parse_args()

    fid_len = args.marker_size
    ...
    print "\nAfter printing, please make sure that the long lines around the marker are EXACTLY " + str(fid_len) + " mm long. This is required for accurate position estimation."
